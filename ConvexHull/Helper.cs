...
public static class Helper
{
    ...
    {
        return !(IsToTheLeft(list[^2], list[^1], list[^3]) >= 0);
    }

    /// <summary>
    /// Returns positive if point r is to the left of the line through p and q. Also returns true if all points are on a line. Only works in 2D.
    /// </summary>
